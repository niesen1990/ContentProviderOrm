...
import com.niesen.cpo.lib.model.util.CursorIterator;
...
public class Select<Model> implements DataFilterClause<Select<Model>> {
    ...
    public int queryAsCount(Context context) {
        ...
        List<String> includedColumnsTemp = new ArrayList<>(includedColumns.size());
        List<String> excludedColumnsTemp = new ArrayList<>(excludedColumns.size());
